								...
								<div class="row row-margin-top">
									<div class="container-fluid">
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											...
											<li class="nav-item"><a class="nav-link"
												href="${pageContext.servletContext.contextPath}/admin-account-add">Thêm
													Tài Khoản</a></li>
										</ul>
												...
												<div class="container-fluid">
													...
													<div class="row row-product">
														<div class="col-lg-5 col-md-5 col-sm-5 col-5">
															<a href="<c:url value="/admin-account-add"/>">
																<button type="button"
																				...
																				<c:if test="${not empty user}">
																					<c:forEach items="${user.getList()}" var="u">
																						<tr>
																							...
																							<td><a
																								href="<c:url value="/admin-account-edit?id=${u.getId()}"/>">${u.getUsername()}</a>
																							</td>
																							<td>${u.getName()}</td>
																							<td>${u.getPhone()}</td>
																							<td>${u.getEmail()}</td>
																							...
																							<c:if test="${u.isRole() != 3}">
																								<td><a
																									href="<c:url value="/admin-account-password?id=${u.getId()}"/>"><button
																											type="button"
																								...
																								<td><a
																									href="<c:url value="/admin-account-edit?id=${u.getId()}"/>"><button
																											type="button"
																											class="btn btn-outline-success btn-sm">
																											<i class="ti-folder"></i>
																										</button></a></td>

																								<td><a href="<c:url value="/admin-account-delete?action=xoa&id=${u.getId()}"/>"><button type="button"
																					...
																					<c:forEach items="${user.getList()}" var="u">
																						<c:if test="${u.isRole() == 1}">
																							<tr>
																								<td>KHÁCH HÀNG</td>
																								<td><a
																									href="<c:url value="/admin-account-edit?id=${u.getId()}"/>">
																										${u.getUsername()}</a></td>
																								<td>${u.getName()}</td>
																								<td>${u.getPhone()}</td>
																								<td>${u.getEmail()}</td>
