								...
								<div class="row row-margin-top">
									<div class="container-fluid">
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											...
											<li class="nav-item"><a class="nav-link"
												href="${pageContext.servletContext.contextPath}/admin-product-add">Thêm
													Sản Phẩm</a></li>
										</ul>
																			...
																			<tbody>
																				<c:if test="${not empty pagedListHolder}">
																					<c:forEach items="${pagedListHolder.pageList}" var="p">
																						<tr>
																							<td><a
																								href="<c:url value="/admin-product-edit?id=${p.getId()}"/>">${p.getName()}
																							</a></td>
																							<td>${p.getCatalog_id()}</td>
																							<td>${p.getGiaString(p.getPrice())}₫</td>
																							<td>${p.getQty()}</td>
																							<td><c:choose>
																							...
																							<td><a
																								href="<c:url value="/admin-product-edit?id=${p.getId()}"/>"><button
																										type="button"
																										class="btn btn-outline-success btn-sm">
																										<i class="ti-folder"></i>
																									</button></a></td>

																							<td><a href="<c:url value="/admin-product-delete?action=xoa&id=${p.getId()}"/>"><button type="button"
