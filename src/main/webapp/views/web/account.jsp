        ...
        <div class="row my-2 user__border">
            ...
            <div class="tab-content py-5" style="width: 100%">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-9">
                                    ...
                                    <br>
                                    <br>
                                    <form action="<c:url value='/sua-thong-tin'/>" method="get">
                                        <a class="form-control" type="text" data-toggle="modal" data-target="#exampleModal" 
                                           style="width: 150px;text-align: center; background-color: gray;border: none;">
                                            Sửa thông tin</a>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <textarea name="address" id="" cols="30"
                                                                          rows="10" >${user.getAddress() }</textarea>
                                                            </div>
                                                            <br>
                ...
                <div class="tab-pane" id="messages">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <form action="<c:url value='/doi-mat-khau'/>" method="post" class="formAcount validate clearfix">
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <label class="col-md-3 control-label"> Mật khẩu cũ: <span style="color: #ff2c18">*</span></label>
                                        <div class="col-lg-6 col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <label class="col-md-3 control-label"> Mật khẩu mới: <span style="color: #ff2c18">*</span></label>
                                        <div class="col-lg-6 col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <label class="col-md-3 control-label"> Xác nhận mật khẩu: <span style="color: #ff2c18">*</span></label> 
                                        <div class="col-lg-6 col-md-9">
                ...
                <div class="tab-pane myorder__style" id="edit">
                    ...
                    <br>
                    <c:forEach items="${order.getList()}" var="ord" varStatus="s">
                        <div class="row" style="border: 1px solid #F6F7FB;background-color: #F6F7FB;">
                            <div class="col-2">
                                <div class="product-img">
                                    <a href="<c:url value="/chi-tiet-san-pham?id=${ord.getMaSP()}"/>">
                            ...
                            <div class="col-4" style="margin:auto;">
                                <h5>
                                	<a href="<c:url value="/chi-tiet-san-pham?id=${ord.getMaSP()}"/>">
                                		${product[s.count].getName()}
                                	</a>
                                </h5><br>${ord.getSoluong() }
                            </div>
                            <div class="col-2" style="margin:auto;">
                                    ${ord.getGiaString(ord.getGia())} đ
