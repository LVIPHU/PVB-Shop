...
<body class="js">
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="<c:url value="/san-pham?&page=0"/>">Sản phẩm</a></li>
                        </ul>
                    </div>
                </div>
            </div>
	...
	<c:url value= "san-pham${catalog_id }" var="pagedLink">
                            ...
                            <ul class="main-category">
                                <% CategoryService categoryService = new CategoryService();
                                    for (CatalogModel catalogModelOrder : categoryService.findAll()) {
                                        ;%>
                                <li>
                                    <a href="san-pham?page=0&catalog_id=<%=catalogModelOrder.getId()%>" style="color: black"><%=catalogModelOrder.getName()%>
                                    </a>
                                </li>
                                <%}%>
                                </li>
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    ...
                    <div class="row">
                        <c:if test="${not empty pagedListHolder}">
                            <c:forEach items="${pagedListHolder.pageList}" var="d">
