				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<form class="form" method="post" action="${pageContext.servletContext.contextPath }/lien-he">
								<div class="row">
					...
					<div class="col-lg-4 col-12">
						<div class="single-head">
							...
							<div class="single-info">
								...
								<ul>
									<li><a href="#">viphu@gmail.com</a></li>
									<li><a href="#">phovi56@gmail.com</a></li>
									<li><a href="#">binhthien@gmail.com</a></li>
									<li><a href="#">pvbcomputer@gmail.com</a></li>
								</ul>
							</div>
							<div class="single-info">
								...
								<ul>
									<li>Trụ sở chính: 97 Man Thiện, TP. Thủ Đức, Việt Nam</li>
								</ul>
							</div>
						</div>
					</div>
