...
<div class="container">
    ...
    <div class="row">
        ...
        <c:forEach items="${sptuongtu.getList()}" var="sptuongtu">
            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                <div class="single-product">
                    <div class="product-img">
                        <div type="hidden" name="masp" style="width: 0px;height: 0px">${sptuongtu.getId()}</div>
                        <a href="<c:url value="/chi-tiet-san-pham?id=${sptuongtu.getId()}"/>">
                            <img class="default-img" src="<c:url value='${sptuongtu.getImage_link()}'/>"
                                 alt="#">
                        </a>
                        <div class="button-head">
                            <div class="product-action">
                                <a title="" href="<c:url value="/chi-tiet-san-pham?id=${sptuongtu.getId()}"/>"><i class=" ti-bag"></i><span>Mua
                                        ngay</span></a>
                    ...
                    <div class="product-content">
                        <h3><a href="<c:url value="/chi-tiet-san-pham?id=${sptuongtu.getId()}"/>">${sptuongtu.getName()} </a></h3>
