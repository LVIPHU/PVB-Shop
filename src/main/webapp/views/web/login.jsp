        ...
        <div class="row">
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        <li><a href="trang-chu">Trang chủ<i class="ti-arrow-right"></i></a></li>
...
<div class="login-form">
    <form action="<c:url value="/dang-nhap"/>" method="post" class="form_signup">
        ...
        <p><a href="<c:url value='/quen-mat-khau'/>"  style="font-size: 14px;text-decoration: none;text-align: right;">Quên mật khẩu?</a></p>
        <div class="form-group">
