...
<body>
<form action=" <c:url value="/employees-product-import"/>" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-8 col-6">
                                <input type="text" class="form-control" id="exampleFormControlTextarea1" name="content" data-value="${product.getContent()}"   placeholder="${product.getContent()}">
                            </div>
                        </div>
                        <div class="gap-sm"></div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <input type="number" class="form-control" min="${product.getQty()}" name="qty"  value="${product.getQty()}" placeholder="${product.getQty()}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align: center;">
                                ...
                                <a href="<c:url value="/employees-product"/>"><button type="button" class="btn btn-outline-danger">Thoát</button></a>
                            </div>
                        </div>
                    </div>
                </div>
