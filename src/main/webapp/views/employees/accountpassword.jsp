...
<body>
<form action=" <c:url value="/employees-account-password"/>" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align: center;">
                                ...
                                <a href="<c:url value="/employees-account"/>"><button type="button" class="btn btn-outline-danger">Thoát</button></a>
                            </div>
                        </div>
                    </div>
                </div>
