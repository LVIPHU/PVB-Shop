...
<body>
	<form action="<c:url value="/employees-order"/> " method="post">
										...
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											...
											<li class="nav-item"><a class="nav-link"
												...
												role="tab" aria-controls="complete" aria-selected="false">Đã
													giao</a></li>
											<li class="nav-item"><a class="nav-link"
												href="${pageContext.servletContext.contextPath}/employees-cancel">Đã
													hủy</a></li>
 											<li class="nav-item"><a class="nav-link"
												href="${pageContext.servletContext.contextPath}/employees-return">Trả
													hàng & Hoàn tiền</a></li>
																				...
																				<c:if test="${not empty transaction}">
																					<c:forEach items="${transaction.getList()}" var="t">
																						<tr>
																							...
																							<td><a
																								href="<c:url value="/employees-order-edit?id=${t.getId()}"/>"><button
																										type="button"
																										class="btn btn-outline-success btn-sm">
																										<i class="ti-folder"></i>
																									</button></a></td>
																							<%-- <c:if test="${t.getStatus() >= 3}">
																							<td><a href="<c:url value="/employees-order-delete?action=xoa&id=${t.getId()}"/>"><button type="button"
																				...
																				<c:if test="${not empty transaction}">
																					<c:forEach items="${transaction.getList()}" var="t">
																						<c:if test="${t.getStatus()==2}">
																							<tr>
																								<td><a
																									href="<c:url value="/order-detail?id=${t.getId()}"/>">${t.getId()}
																								</a></td>
																								<td>${t.getUser_address()}</td>
																								<td>${t.getAmount()}</td>
																								<td>${t.getShipping_date()}</td>
