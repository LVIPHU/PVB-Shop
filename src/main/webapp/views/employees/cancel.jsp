...
<title>P.V.B | Danh sách đơn hủy</title>
<!-- Font awesome -->
...
<body>
	<form action="<c:url value="/employees-cancel"/> " method="post">
																				...
																				<c:forEach items="${transaction.getList()}" var="t">
																					<c:if test="${t.getStatus()==4}">
																						<tr>
																							...
																							<%-- <td><a
																								href="<c:url value="/employees-order-delete?action=xoa&id=${t.getId()}"/>"><button
																										type="button"
