                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            <li><i class="ti-email"></i>pvbcomputer@gmail.com</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                    ...
                    <div class="mobile-nav">
                        <div class="slicknav_menu"><a href="#" aria-haspopup="true" role="button" tabindex="0"
                            ...
                            <ul class="slicknav_nav slicknav_hidden" aria-hidden="true" role="menu"
                                ...
                                <li><a href="<c:url value="/san-pham"/>" role="menuitem" tabindex="-1">Sản
                                    phẩm</a></li>
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="#" class="single-icon"><i class="ti-bag"></i> 
                            	<c:if test="${not empty cart }">
                            		<span class="total-count">${cart.getList().size()}</span>
                            	</c:if>
                            </a>
                            <!-- Shopping Item -->
                                    ...
                                    <c:if test="${not empty cart}">
                                        <c:forEach items="${cart.getList()}" var="c">
                                            <li>
                                                ...
                                                <p><span class="amount">${c.getGiaString(c.getGiatien())}₫</span></p>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                            ...
                            <ul class="main-category">
                                <% CategoryService categoryService = new CategoryService();
                                    for (CatalogModel catalogModelOrder : categoryService.findAll()) {
                                        ;%>
                                <li>
                                    <a href="san-pham?catalog_id=<%=catalogModelOrder.getId()%>&page=0"><%=catalogModelOrder.getName()%>
                                    </a>
                                </li>
                                <%}%>
                            </ul>
