...
@WebServlet(name = " ECancelController", urlPatterns = "/employees-cancel")
public class ECancelController extends HttpServlet {
	@Inject
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/views/employees/cancel.jsp");
