...
@WebServlet(name = "EReturnController", urlPatterns = "/employees-return")
public class EReturnController extends HttpServlet {
	@Inject
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/views/employees/return.jsp");
