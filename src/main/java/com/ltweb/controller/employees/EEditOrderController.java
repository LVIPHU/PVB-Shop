...
@WebServlet(urlPatterns = "/employees-order-edit")
public class EEditOrderController extends HttpServlet{
	@Inject
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/views/employees/editorder.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(transactionModel != null){
            ...
            response.sendRedirect(request.getContextPath() + "/employees-order?message=edit_account_success&alert=success");
        } else {response.sendRedirect(request.getContextPath() + "/employees-order-edit?message=edit_account_notsuccess&alert=danger");}
    }
}
