...
@WebServlet(urlPatterns = "/employees-category-edit")
public class EEditCategoryController extends HttpServlet {
	@Inject
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/views/employees/editcategory.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (catalogModel != null) {
			...
			response.sendRedirect(request.getContextPath() + "/employees-category?message=edit_category_success&alert=success");
		} else {response.sendRedirect(request.getContextPath() + "/employees-category-edit?message=edit_category_notsuccess&alert=danger");}
	}
}
